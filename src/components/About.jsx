...
const About = ({ soundEnabled }) => {
  return (
    <section id="about" className="py-24 relative z-10 bg-[#070504]">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold font-outfit text-slate-100 tracking-tight mb-4">
            About <span className="text-gradient-gold">Haider Ali</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="bg-[#140e09]/90 rounded-3xl p-8 border border-amber-900/30 relative overflow-hidden shadow-xl">
              ...
              <h3 className="text-2xl font-bold font-outfit text-slate-100 mb-4 flex items-center gap-3">
                <span className="text-amber-400 font-mono text-xl">&gt;_</span>
              ...
              <p className="text-slate-300 leading-relaxed font-light mb-6">
                In addition to web development, I offer extensive expertise in <strong className="text-yellow-400">Canva Graphic Design</strong> (social media graphics, logos, presentation decks, banner assets) and <strong className="text-amber-300">MS Excel Data Entry & Management</strong> (spreadsheet formulas, data cleaning, automated reports).
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-amber-900/30">
          ...
          >
            {personalData.stats.map((stat, idx) => (
              <div
                key={idx}
                className="bg-[#140e09]/90 rounded-2xl p-6 border border-amber-900/30 hover:border-amber-500/50 transition-all text-center group shadow-md"
                onMouseEnter={() => playSound('hover', soundEnabled)}
              >
                <div className="text-3xl sm:text-4xl font-black font-outfit text-gradient-gold mb-2 group-hover:scale-110 transition-transform">
                  {stat.value}
                </div>
