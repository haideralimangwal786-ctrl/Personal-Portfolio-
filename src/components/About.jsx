...
const About = ({ soundEnabled }) => {
  return (
    <section id="about" className="py-24 relative z-10 bg-[#030712]">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold font-outfit text-[#ffffff] tracking-tight mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="glass-panel rounded-3xl p-8 border border-slate-800 relative overflow-hidden shadow-xl">
              <div className="absolute top-0 right-0 w-32 h-32 bg-sky-500/10 rounded-full blur-2xl pointer-events-none"></div>

              <h3 className="text-2xl font-bold font-outfit text-white mb-4 flex items-center gap-3">
                <span className="text-sky-400 font-mono text-xl">&gt;_</span>
                MERN Stack Developer & Digital Specialist
              </h3>

              <p className="text-slate-300 leading-relaxed font-light mb-4 text-base">
              ...
              <p className="text-slate-300 leading-relaxed font-light mb-6 text-base">
                In addition to web development, I offer extensive expertise in <strong className="text-purple-300 font-semibold">Canva Graphic Design</strong> (social media graphics, logos, presentation decks, banner assets) and <strong className="text-emerald-400 font-semibold">MS Excel Data Entry & Management</strong> (spreadsheet formulas, data cleaning, automated reports).
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-slate-800">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-slate-100">MERN Web Architecture</h4>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-slate-100">Canva & UI Design</h4>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-slate-100">Excel Data Entry</h4>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-slate-100">REST APIs & Cloud</h4>
          ...
          >
            {personalData.stats.map((stat, idx) => (
              <div
                key={idx}
                className="glass-panel rounded-2xl p-6 border border-slate-800 hover:border-sky-500/40 transition-all text-center group shadow-md"
