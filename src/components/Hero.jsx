...
const Hero = ({ soundEnabled, onOpenCommand }) => {
  ...
  return (
    <section id="hero" className="relative min-h-screen pt-28 pb-20 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] bg-cyan-500/10 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 mb-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-emerald-500/30 text-emerald-400 text-xs font-mono shadow-sm">
              ...
              <button
                ...
                className="hidden sm:inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-900/80 border border-slate-700 text-slate-300 text-xs font-mono hover:border-cyan-500/50 hover:text-cyan-400 transition-all cursor-pointer"
              >
            ...
            <div className="h-10 flex items-center gap-2.5 mb-6 font-mono text-lg sm:text-xl text-slate-300 bg-slate-900/60 px-4 py-2 rounded-xl border border-slate-800/80">
              <span className="text-cyan-400 font-bold">&gt;_</span>
              <span className="text-slate-100 font-semibold">{displayText}</span>
              <span className="w-2 h-5 bg-cyan-400 animate-pulse inline-block rounded-sm"></span>
            </div>

            {/* Clean Bio Summary */}
            <p className="text-base sm:text-lg text-slate-300 leading-relaxed mb-8 max-w-xl font-normal">
              Full-Stack Developer crafting modern web applications with the <span className="text-cyan-400 font-semibold">MERN Stack</span>. Specializing in responsive React interfaces, <span className="text-purple-400 font-semibold">Canva Graphic Design</span>, and automated <span className="text-emerald-400 font-semibold">MS Excel Data Systems</span>.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 w-full sm:w-auto mb-10">
              <a
                ...
                onMouseEnter={() => playSound('hover', soundEnabled)}
                className="px-7 py-3.5 text-sm font-bold text-slate-950 bg-gradient-to-r from-cyan-400 via-teal-300 to-purple-400 rounded-xl shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2.5"
              >
              ...
              <a
                ...
                onClick={() => playSound('click', soundEnabled)}
                onMouseEnter={() => playSound('hover', soundEnabled)}
                className="px-6 py-3.5 text-sm font-semibold text-slate-200 bg-slate-900/90 hover:bg-slate-800 border border-slate-700/80 hover:border-cyan-500/40 rounded-xl transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                onMouseEnter={() => playSound('hover', soundEnabled)}
                className="px-4 py-3.5 text-xs font-mono text-slate-300 bg-slate-900/90 hover:bg-slate-800 border border-slate-700/80 rounded-xl transition-all flex items-center gap-2"
                title="Copy Email"
              >
                {copied ? (
                  <>
            ...
            <div className="w-full pt-6 border-t border-slate-800/80 grid grid-cols-3 gap-4 font-mono">
              <div>
                <span className="text-2xl font-bold text-cyan-400 font-outfit">5+</span>
          ...
          >
            ...
            <div className="relative rounded-3xl bg-slate-900/80 border border-slate-800 shadow-2xl p-6 overflow-hidden">
              
              {/* Top Showcase Navigation Tabs */}
              <div className="flex items-center justify-between gap-2 p-1 bg-slate-950/90 rounded-xl border border-slate-800 mb-6">
                <button
                  onClick={() => {
                    playSound('click', soundEnabled);
              ...
              <AnimatePresence mode="wait">
                {activeTab === 'projects' && (
                  ...
                  >
                        ...
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg text-xs font-mono transition-all flex items-center gap-1.5 whitespace-nowrap ${
                            selectedProjectIndex === idx
                              ? 'bg-slate-800 text-cyan-400 border border-cyan-500/50 font-semibold'
                    ...
                    <div className="bg-slate-950/90 rounded-2xl border border-slate-800/90 p-5 flex flex-col gap-3 relative overflow-hidden">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs text-slate-500 font-mono">Featured App</span>
                      </div>
                ...
                {activeTab === 'profile' && (
                  ...
                  >
                    <div className="relative w-28 h-28 rounded-full p-1 bg-gradient-to-tr from-cyan-400 to-purple-500 mb-3 shadow-lg">
                      <img
                        src="/profile.png"
                        alt="Haider Ali"
                    ...
                    <p className="text-xs font-mono text-cyan-400 mb-4">MERN Stack & Digital Specialist</p>

                    <div className="w-full grid grid-cols-2 gap-2 text-xs font-mono text-left bg-slate-950/80 p-3 rounded-xl border border-slate-800 mb-2">
                      <div>
                  ...
                  >
                    <div className="bg-slate-950/80 p-3 rounded-xl border border-slate-800">
                      <div className="flex justify-between mb-1">
                        <span className="text-cyan-400 font-semibold">React.js & Node.js</span>
